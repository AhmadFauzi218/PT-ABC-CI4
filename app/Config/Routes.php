...
$routes->get('Pengguna/add', 'Pengguna::create');
$routes->post('Pengguna', 'Pengguna::store');
$routes->get('Pengguna/edit/(:any)', 'Pengguna::edit/$1');
$routes->put('Pengguna/(:any)', 'Pengguna::update/$1');
$routes->delete('Pengguna/(:any)', 'Pengguna::destroy/$1');
...
$routes->delete('produk/(:any)', 'Produk::destroy/$1');
